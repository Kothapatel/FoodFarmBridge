...
const Home = () => {
  ...
  const filteredProductData = productData.filter(
    (product) => !excludeProductNames.includes(product.name.toLowerCase())
  );

  // Define home product lists
  const homeProductCartList = filteredProductData.slice(0, 4);
  const homeProductCartListVegetables = filteredProductData.filter(el => el.category === "vegetable");
  const homeProductCartListFruits = filteredProductData.filter(el => el.category === "fruits");
    ...
    <div className='p-2 md:p-4'>
      <div className='md:flex gap-4 py-2'>
        <div className='md:w-1/2'>
          ...
          <p className='py-3 text-base'>Organic food that is sent direct to your Home..</p>
          <button className='font-bold bg-red-500 text-slate-200 px-4 py-2 rounded'>Order Now</button>
        </div>
        <div className='md:w-1/2 flex flex-wrap gap-5 p-4 justify-center'>
          {homeProductCartList.length ? 
      ...
      <div className='py-4'>
        ...
        <div className='flex gap-5 overflow-scroll scrollbar-none scroll-smooth transition-all' ref={slideProductRef}>
          {homeProductCartListVegetables.length ? 
      ...
      <div className='py-4'>
        ...
        <div className='flex gap-5 overflow-scroll scrollbar-none scroll-smooth transition-all' ref={slideProductRef}>
          {homeProductCartListFruits.length ? 
...
//           </div>
//           <h2 className='text-4xl md:text-7xl font-bold py-3'>The Fastest Delivery to <span className='text-red-500 '>Your Home</span></h2>
//           <p className='py-3 text-base '> Organic food that sent direct to your Home..</p>
//           <button className='font-bold bg-red-500 text-slate-200 px-4 py-2 rounded'>Order Now</button>
//         </div>
//         <div className='md:w-1/2 flex flex-wrap gap-5 p-4 justify-center'>
//           {
